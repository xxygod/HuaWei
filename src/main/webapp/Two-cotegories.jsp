...
<head>
    ...
    <script src="js/public-reception/push.js"></script>

    <title>手机大全_二级分类</title>

    <link type="text/css" href="css/public-reception/index2_1.css" rel="stylesheet" charset=“utf-8”>
    <link type="text/css" href="css/public-reception/index2_2.css" rel="stylesheet" charset=“utf-8”>
    <link type="text/css" href="css/public-reception/index2_3.css" rel="stylesheet" charset=“utf-8”>

    <script src="js/public-reception/jquery-1.8.3.js"></script>
    <script src="js/public-reception/esapi.js"></script>
</head>
...
<div class="layout">
    ...
    <div class="pro-cate-area">
        ...
        <div class="pro-cate-attr clearfix">
            ...
            <div class="p-default">
                <ul>
                    <li id="first-category" class="selected"><a href="queryOCproduct?oneCategoryId=1">全部</a></li>
                </ul>
            </div>
            ...
            <div class="p-values">
                ...
                <div class="p-expand">
                    <ul class="clearfix">
                        ...
                        <c:forEach items="${twoCategories}" var="tc">
                            <li><a href="queryTCproduct?twoCategoryId=${tc.twoCategoryId}">${tc.twoCategoryName}</a></li>
                        </c:forEach>
            ...
            <div class="p-values" style="margin-left:95px;">
                <div class="p-expand">
                    <ul class="clearfix">
                        ...
                        <li id="sort-3" con="1" class="<c:if test="${order eq 'productDate'}">selected <c:if test="${by eq 'asc'}">sort-asc</c:if><c:if test="${by eq 'desc'}">sort-desc</c:if></c:if>">
                            <a href="javascript:;" class="sort-added" >上架时间<s></s></a>
                        </li>
                        <li id="sort-1" con="1" class="<c:if test="${order eq 'productPrice'}">selected <c:if test="${by eq 'asc'}">sort-asc</c:if><c:if test="${by eq 'desc'}">sort-desc</c:if></c:if>" >
                            <a href="javascript:;" class="sort-price">价格<s></s></a>
                        </li>
                        <script>
                            $(document).ready(function(){
                                $("#sort-3").click(function(){
                                    var con=$(this).attr("class");
                                    if(con == ""||con == "selected sort-desc"){
                                        window.location.href="/orderBy?order=productDate&by=asc";
                                    }else if(con == "selected sort-asc"){
                                        window.location.href="/orderBy?order=productDate&by=desc";
                                    }
                                });
                                $("#sort-1").click(function(){
                                    var con=$(this).attr("class");
                                    if(con == ""||con == "selected sort-desc"){
                                        window.location.href="/orderBy?order=productPrice&by=asc";
                                    }else if(con == "selected sort-asc"){
                                        window.location.href="/orderBy?order=productPrice&by=desc";
                                    }
                                });
                            });
                        </script>
...
<script src="js/public-reception/new_list.min.js"></script>
<script id="jsapi_loader4" loadtype="insert" type="text/javascript"
        src="js/public-reception/jquery.form-2.49.js" charset="utf-8"></script>
<script>(function () {
...
<script id="jsapi_loader5" loadtype="insert" type="text/javascript" src="js/common/base/ajax.js"
...
<script id="jsapi_loader6" loadtype="insert" type="text/javascript" src="js/public-reception/pager-min.js"
        charset="gbk"></script>
<script>(function () {
    ...
    <div class="channel-list">
        ...
        <div class="pro-list clearfix">
            <ul>
                ...
                <c:forEach items="${page.list}" var="mmp">
                    <li>
                        <div class="pro-panels">
                            <p class="p-img">
                                <a target="_blank" href="<%=path%>/queryByIdProduct?productId=${mmp.productId}" title="">
                                    <img alt="${mmp.productName}" src="<%=path%>/hw/${mmp.logo}">
                                </a>
                            </p>
                            <p class="p-name">
                                <a target="_blank" href="#" title="${mmp.productName}">
                                    <span>${mmp.productName}</span>
                                    <span class="red"></span>
                                </a>
                            </p>
                            <p class="p-price"><b>${mmp.productPrice}</b></p>
                            <div class="p-button clearfix">
                                <table colspan="0" border="0" rowspan="0">
                                    <tbody>
                                        <tr>
                                            <td><a href="<%=path%>/queryByIdProduct?productId=${mmp.productId}" target="_blank" class="p-button-an">
                                                <span><p style="text-align: center">选购</p></span></a>
                                            </td>
                                            <td><label class="p-button-score">
                                                <span><p style="text-align: center">0人评价</p></span></label>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <c:if test="${fn:length(page.list)==0}">
                    <div style="text-align:center;">很抱歉没有你想要的商品！！！</div>
                </c:if>
            </ul>
        </div>
        <!-- 20140727-商品列表-end -->
        ...
        <div id="list-pager-36" class="pager">
            ...
            <ul id="page_ul">
                <a href="<%=path%>/productPage?currentPage=${page.firstPage}" target="_self"><li class="pgNext link first first-empty" >|&lt;</li></a>

                <a href="<%=path%>/productPage?currentPage=${page.pageNum-1}" target="_self"><li class="pgNext link pre pre-empty">&lt;</li></a>
                <c:forEach items="${page.navigatepageNums}" var="pageSize">
                    <c:if test="${pageSize eq page.pageNum}" var="paCurrent">
                        <a id="page_1" href="<%=path%>/productPage?currentPage=${pageSize}" target="_self">
                            <li class="page-number link pgCurrent">${pageSize}</li>
                        </a>
                    </c:if>
                    <c:if test="${!paCurrent}">
                        <a id="page_1" href="<%=path%>/productPage?currentPage=${pageSize}" target="_self">
                            <li class="page-number link">${pageSize}</li>
                        </a>
                    </c:if>
                </c:forEach>
                <a href="<%=path%>/productPage?currentPage=${page.pageNum+1}" target="_self"><li class="pgNext link next">&gt;</li></a>

                <a href="<%=path%>/productPage?currentPage=${page.lastPage}" target="_self"><li class="pgNext link last">&gt;|</li></a>
            </ul>
        </div>
        </c:if>
    </div>
...
<script>
    ...
    function pushListProClickMsg(skuCode) {
        ...
        ec.account.dapPushMsg("300120101", value, "click");
        ec.code.addAnalytics({hicloud: true});
...
<div class="hungBar j-hungBar">
    <div class="hungBar-content">
        <a target="_blank" onclick="pushMyCartMsg()" href="#" timetype="timestamp"
           class="hungBar-cart" title="购物车"><span style="display:none;"></span><i>购物车</i></a>
        <a target="_blank" id="tools-nav-service-robotim" onclick="pushRightHelpMsg('在线客服')"
           href="userManager/customer_service.jsp" class="hungBar-service" title="在线客服" style="display: block;"><i>在线客服</i></a>
        ...
        <a href="javascript:;" class="hungBar-top" title="返回顶部" id="hungBar-top"
           style="display: none; opacity: 0.0468245;"><i>返回顶部</i></a>
    </div>
</div>
...
<script>
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1545964482503timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
...
<script src="js/public-reception/dmpa-min.js" async="" id="dmpa"></script>
