                ...
                <li>
                    <div class="s-dropdown s-dropdown-minicart">
                        <div class="h h-wide" id="header-toolbar-minicart">
                            <a href="/cart2?t=1546431900889timestamp" class="icon-minicart" rel="nofollow"
...
<div class="header">
    <div class="layout">
        <div class="left">
            ...
            <div class="logo"><a href="../index.jsp" title="Vmall.com - 商城">
            ...
            <div class="search-bar relative" id="searchBar-area">
                ...
                <div class="search-bar-key" id="search-bar-key">
                    <div class="searchBar-key">
                        <a href="#" style="color:#CF0A2C" rel="nofollow">荣耀V20</a>
                        <a href="#" style="color:#CF0A2C" rel="nofollow">nova4</a>
                    </div>
                </div>
...
<div id="base_index" class="">
    ...
    <div class="g">
        ...
        <div class="breadcrumb-area fcn"><a href="../index.jsp">首页</a>&nbsp;&gt;&nbsp;<em id="personCenter"><a
                href="details.jsp">我的商城</a></em><em id="pathPoint">&nbsp;&gt;&nbsp;</em><span id="pathTitle"></span>
        </div>
    </div>
    <div class="hr-10"></div>
                ...
                <div class="list-group" id="list-group">
                    <div class="list-group-item read">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="col-type">
                                    <i><img src="../images/userManager-imager/4SMZZF6%5B@VX_ZW%5DCQWDCDYW.png"></i>
                                    <span> 通知 </span>
                                </td>
                                <td class="col-title">
                                    <a href="#" title="精选圣诞好礼，总有一款适合你" target="_blank">精选圣诞好礼，总有一款适合你</a>
                                </td>
                                <td class="col-date">2018-12-21 21:04:19</td>
                    ...
                    <div class="list-group-item read">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="col-title">
                                    <a href="#" title="暖冬钜献，华为多款新品来袭" target="_blank">暖冬钜献，华为多款新品来袭</a>
                                </td>
                                <td class="col-date">2018-12-13 18:24:26</td>
                                <td class="col-operate">
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="list-group-item read">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="col-title">
                                    <a href="#" title="1212年终狂欢进行时" target="_blank">1212年终狂欢进行时</a>
                                </td>
                                <td class="col-date">2018-12-12 14:23:17</td>
                                <td class="col-operate">
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="list-group-item read">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="col-title">
                                    <a href="#" title="12.12 AI精彩，购狂欢" target="_blank">12.12
                                        AI精彩，购狂欢</a>
                                </td>
                                <td class="col-date">2018-12-10 16:43:27</td>
                                <td class="col-operate">
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="list-group-item read">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="col-title">
                                    <a href="#" title="荣耀12·12嗨购"
                                       target="_blank">荣耀12·12嗨购</a>
                                </td>
                                <td class="col-date">2018-12-06 17:54:43</td>
                                <td class="col-operate">
                                </td>
                            </tr>
                            </tbody>
            ...
            <div id="ec_ui_confirm" class="popup-area popup-define-area hide">
                <div class="b">
                    ...
                    <div class="popup-button-area"><a id="ec_ui_confirm_yes" href="javascript:;"
                            ...
                            id="ec_ui_confirm_no" href="javascript:;" class="button-action-no"><span>否</span></a></div>
                </div>
                <div class="f"><s class="icon-arrow-down"></s></div>
            </div>
            <div class="hr-75"></div>
            <input type="hidden" id="msgType" value="msg"/>
            <script src="../js/userManager-js/list.min.js"></script>
            <script>
                ec.load("ec.pager");
                ec.mediaPath = "https://res.vmallres.com/pimages/";
            </script>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ol>
                                ...
                                <li id="li-exchange"><a href="salesReturn.jsp"><span>我的退换货</span></a></li>
...
<div class="hungBar j-hungBar">
    <div class="hungBar-content">
        <a target="_blank" href="#" timeType="timestamp" class="hungBar-cart" title="购物车">
            <span style="display:none;"></span><i>购物车</i></a>
        <a target="_blank" id="tools-nav-service-robotim" href="#" class="hungBar-service" title="在线客服"><i>在线客服</i></a>
        <a id="tools-nav-survery" href="#" class="hungBar-feedback" title="意见反馈"><i>意见反馈</i></a>
...
<script>
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1546431900926timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
