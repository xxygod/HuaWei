...
<head>
    ...
    <script src="../js/userManager-jsjs/jsapi.js" namespace="ec"></script>
                ...
                <li>
                    <div class="s-dropdown s-dropdown-minicart">
                        <div class="h h-wide" id="header-toolbar-minicart">
                            <a href="/cart2?t=1546505890162timestamp" class="icon-minicart" rel="nofollow"
...
<div id="base_index" class="">
    ...
    <div class="g">
        <div class="fr u-4-5"><!-- 20141212-栏目-start -->
            ...
            <div class="order-pay-success-area">
                <div class="b">
                    <div class="prevention-fraud">
                        <p class="prevention-fraud-tips">注意：商城不会以订单异常、系统升级为由，要求您点击任何链接进行退款！
                        请谨防<span>钓鱼链接或诈骗电话</span>！</p></div>
                </div>
            </div>
            <!-- 20151208-防诈骗提示-end -->
            ...
            <div class="myOrder-cate myExch-cate">
                <ul>
                    <li class="current"><a href="javascript:;" onclick="ec.member.refundList.cateLive(this,1);">
                        <span>最近六个月<em></em></span></a>
                    </li>
                    <li><a href="javascript:;" onclick="ec.member.refundList.cateLive(this,0);">
                        <span>六个月以前<em></em></span></a>
                    </li>
                </ul>
            </div>
            <div class="hr-20"></div>
            ...
            <textarea id="exchange-tpl" class="hide">
	...
	<div class="list-group-item">
		<table border="0" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					<td class="col-no"><a href="/member/refund?ordercode={#lst.ordCode}&isLive={#isLive}"
                                          title="{#lst.ordCode}">{#lst.ordCode}</a></td>
					<td class="col-no"> {#lst.code}</td>
					<td class="col-date">{#new Date(lst.applyDate).format("yyyy-MM-dd HH:mm:ss")}</td>
					<td>&yen; {#lst.amt}</td>
            ...
            <!-- 未找到的脚本 -->
            <script src="https://res9.vmallres.com/20181222/js/uum/member/exchange/refundList.min.js?20170920"></script>
...
<script>
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1546505890191timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
