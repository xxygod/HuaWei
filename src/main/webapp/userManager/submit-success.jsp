        ...
        <div class="contentArea clearfix">
            ...
            <div class="cashier_order_area clearfix" id="cashierHome">
                <div style="margin: 50px">
                    <img src="../images/userManager-imager/success_icon.png"/>
                    <span style="font-size: 24px;color: red">订单提交成功,付款吧~~</span>
                </div>
                <div style="float: right">订单金额:
                    <span style="font-size: 20px;color: red">¥${taotalMoney}</span>
                </div>
            </div>
            <ul class="payBtn clearfix">
                <li>
                    <button class="confirmPay pull-right" name="msg_payBtn">确认支付</button>
                    <div id="cashCoupon">
                    </div>
                </li>
                <script>
                    $(document).ready(function(){
                        $("button[name='msg_payBtn']").click(function(){
                            window.location.href="/userManager/zhifu?opr=1";
                        });
                    })
                </script>
            </ul>
