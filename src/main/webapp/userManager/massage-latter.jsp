...
<head>
    ...
    <script src="../css/userManager-css/jsapi.js" namespace="ec"></script>
    <script src="../css/userManager-css/jquery-1.4.4.min.js"></script>
    <script src="../css/userManager-css/ec.core.js"></script>
    <script src="../css/userManager-css/ec.business.min.js"></script>
    <script src="../css/userManager-css/base.min.js"></script>
    <script src="../css/userManager-css/slider.min.js"></script>
    <script src="../css/userManager-css/swiper.min.js"></script>
    <![endif]-->
</head>
                ...
                <li>
                    <div class="s-dropdown s-dropdown-minicart">
                        <div class="h h-wide" id="header-toolbar-minicart">
                            <a href="/cart2?t=1546676063015timestamp" class="icon-minicart" rel="nofollow"
            ...
            <div class="myMail-detail">
                <div class="h">
                    <div class="mail-soure">
                        <label>发信人：<span>华为商城</span></label><label>发送时间：<span>2018-12-21 21:04:19</span></label></div>
                    <h1>精选圣诞好礼，总有一款适合你</h1>
                </div>
                <div class="b">
                    <p><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">Mate20|X购机限量赠圣诞礼包，<a
                            href="#">Pick新机&gt;&gt;</a></span></span></p>

                    <p><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">荣耀V20年度钜献，预订<a
                            href="#">赢日本豪华游轮双人游&gt;&gt;</a></span></span></p>

                </div>
            </div>
            <input type="hidden" id="isread" value="0"/>
            <input type="hidden" id="msg_type" value="2"/>
            <!-- 20141218-站内信-内容-end -->
            <script>
                ec.ready(function () {
...
<div class="hungBar j-hungBar">
    <div class="hungBar-content">
        <a target="_blank" href="#" timeType="timestamp" class="hungBar-cart" title="购物车"><span style="display:none;"></span>
            <i>购物车</i></a>
        <a target="_blank" id="tools-nav-service-robotim" href="customer_service.jsp" class="hungBar-service" title="在线客服">
            <i>在线客服</i></a>
        <a id="tools-nav-survery" href="#" class="hungBar-feedback" title="意见反馈">
            <i>意见反馈</i></a>
...
<script>
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1546676063047timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
