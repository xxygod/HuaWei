...
<div id="base_index" class="">
    ...
    <div class="g">
        ...
        <div class="breadcrumb-area fcn"><a href="../index.jsp">首页</a>&nbsp;&gt;&nbsp;<em id="personCenter"><a
                href="order.jsp">我的商城</a></em><em id="pathPoint">&nbsp;&gt;&nbsp;</em><span id="pathTitle"></span>
        </div>
    </div>
    ...
    <div class="g">
        <div class="fr u-4-5">
            <div class="fl mc-middle">
                        ...
                        <div class="mc-user-card fl">
                            <div class="user-head fl">
                                <div class="user-canvas "> <!--未登录时添加class="hide"-->
                                    <span class="icon-vip-level-1" id="levelIcon"></span>
                                    <div class="canvas-bg">
                            ...
                            <div class="mc-user-info fl ">
                                <div class="name">${userLogin.screenName}</div>
                                <br/>
                                <br/>
                                <a href="#" class="mc-user-btn">帐号中心</a>
                            </div>
                        </div>
                        <div class="mc-user-huaban fl">
                            <ul class="clearfix">
                                <li>
                                    <a href="integral.jsp" class="p-icon p-icon-1"></a>
                                    <p class="p-dec">积分</p>
                                    <p class="p-price">
                                        <span id="balanceicon_myCenter" class="p-price-no">${userLogin.userInfo.userPoint}</span>分
                                    </p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="mc-user-portal">
                        <ul class="clearfix">
                            <li class="portal-icon-1">
                                <a href="<%=path%>/userManager/queryOrder?opr=unpaid"><span id="un_payment">
                                    <c:if test="${unpaidNumber != 0}">
                                        <em>${unpaidNumber}</em>
                                    </c:if>
                                </span>待支付</a>
                            ...
                            <li class="portal-icon-2">
                                <a href="<%=path%>/userManager/queryOrder?opr=take"><span id="un_received">
                                   <c:if test="${receivingNumber != 0}">
                                       <em>${receivingNumber}</em>
                                   </c:if>
                                </span>待收货</a>
                                <span id="un_received_wechat" style="display:  none;"></span>
                            </li>
                            <li class="portal-icon-4">
                                <a href="<%=path%>/userManager/queryOrder?opr=accomplish"><span>
                                     <c:if test="${stocksNumber != 0}">
                                         <em>${stocksNumber}</em>
                                     </c:if>
                                </span>已完成</a>
                            </li>
                ...
                <div class="mynews">
                    ...
                    <div class="mynews-list">
                        ...
                        <!--全图-->
                        <div class="my_center">
                            <img src="../images/userManager-imager/4WxXMU6HRAT4VBPwFVBF.jpg">
                        </div>
                        <br/>
                        <!--全图-->
                        <div class="my_center">
                            <img src="../images/userManager-imager/8203J1lDlGxkTRUxkmJu.jpg">
                        </div>
                        <br/>
                        <!--全图-->
                        <div class="my_center">
                            <img src="../images/userManager-imager/lozGxhixZJ0nTGhLodFb.jpg">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <script src="../js/userManager-js/index.min.js"></script>
            <script src="../js/userManager-js/zhima.min.js"></script>
            <script src="../js/userManager-js/swiper.min.js"></script>
        </div>
            ...
            <div class="service-code clearfix">
                ...
                <ul class="clearfix">
                    ...
                    <li class="service-code-toutiao">
                        <a target="_blank" href="#" rel="nofollow" style="display:block; width:20px; height:20px;"></a></li>
...
<script>
    ...
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1546679137351timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
