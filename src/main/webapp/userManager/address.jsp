...
<head>
    ...
    <link rel="stylesheet" href="../css/userManager-css/ec.core.base.min.css">
    <link rel="stylesheet" href="../css/userManager-css/main.min.css">
</head>
                                ...
                                <div class="h">
                                    <div class="">
                                        <c:if test="${not empty sessionScope.userLogin}" var="user">
                                            <a href="/userManager/details">${userLogin.screenName}</a>
                                        </c:if>
                                        <c:if test="${!user}">
                    ...
                    <ul id="zxnav_0_prolist" class="grid-list clearfix">
                        ...
                        <c:forEach items="${queryPhone}" var="mmm">
                            <li class="grid-items" onmouseenter="fixCurrent(this)" onmouseleave="leaveCurrent(this)">
                                <a class="thumb" target="_blank" href="/queryByIdProduct?productId=${mmm.productId}">
                                    <p class="grid-img"><img src="/hw/${mmm.logo}"></p>
                ...
                <div id="naverSub01" class="naver-sub-wrap hide">
                    ...
                    <ul id="zxnav_1_prolist" class="grid-list clearfix">
                        ...
                        <c:forEach items="${queryCp}" var="mp">
                            <li class="grid-items" onmouseenter="fixCurrent(this)" onmouseleave="leaveCurrent(this)">
                                <a class="thumb" target="_blank" href="/queryByIdProduct?productId=${mmm.productId}">
                                    <p class="grid-img"><img src="/hw/${mp.logo}"></p>
                ...
                <div id="naverSub02" class="naver-sub-wrap hide">
                    ...
                    <ul id="zxnav_2_prolist" class="grid-list clearfix">
                        ...
                        <c:forEach items="${queryWatch}" var="qw">
                            <li class="grid-items" onmouseenter="fixCurrent(this)" onmouseleave="leaveCurrent(this)">
                                <a class="thumb" target="_blank" href="/queryByIdProduct?productId=${mmm.productId}">
                                    <p class="grid-img"><img src="/hw/${qw.logo}"></p>
                ...
                <div id="naverSub03" class="naver-sub-wrap hide">
                    ...
                    <ul id="zxnav_3_prolist" class="grid-list clearfix">
                        ...
                        <c:forEach items="${queryHome}" var="qh">
                            <li class="grid-items" onmouseenter="fixCurrent(this)" onmouseleave="leaveCurrent(this)">
                                <a class="thumb" target="_blank" href="/queryByIdProduct?productId=${mmm.productId}">
                                    <p class="grid-img"><img src="/hw/${qh.logo}"></p>
                ...
                <div id="naverSub04" class="naver-sub-wrap hide">
                    ...
                    <ul id="zxnav_4_prolist" class="grid-list clearfix">
                        ...
                        <c:forEach items="${queryParts}" var="qp">
                            <li class="grid-items" onmouseenter="fixCurrent(this)" onmouseleave="leaveCurrent(this)">
                                <a class="thumb" target="_blank" href="/queryByIdProduct?productId=${mmm.productId}">
                                    <p class="grid-img"><img src="/hw/${qp.logo}"></p>
...
<div id="base_index" class="">
        ...
        <div class="fr u-4-5">
            ...
            <div class="myAddress-edit" id="myAddress-edit">
                <div class="form-edit-panels" id="form-edit-panels">
                    <form id="myAddress-form" action="/addUA" method="post">
                        <div class="form-edit-table">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                <tr>
                                    <input type="hidden" name="addressId" value="${userAddres.addressId}"/>
                                    <th><span class="required">*</span><label >收货人：</label></th>
                                    <td>
                                        <input maxlength="20" type="text" name="consignee" value="${userAddres.consignee}" id="consignee" class="text span-130"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="inline-block vam relative">
                                            <input maxlength="50" type="text" name="phone" value="${userAddres.phone}" id="phone"
                                                   class="text span-310 ime-disabled" alt="tel-msg"/></div>
                                        <div><label id="tel-msg"></label></div>
                                    </td>
                                </tr>
                                <tr>
                                    <th><span class="required">*</span><label >省：</label></th>
                                    <td>
                                        <div class="inline-block vam relative">
                                            <input maxlength="50" type="text" name="province" id="province"
                                                   class="text span-310 ime-disabled" value="${userAddres.province}"/></div>
                                        <div><label id="tel-msg"></label></div>
                                    </td>
                                </tr>
                                <tr>
                                    <th><span class="required">*</span><label >市：</label></th>
                                    <td>
                                        <div class="inline-block vam relative">
                                            <input maxlength="50" type="text" name="city" id="city"
                                                   class="text span-310 ime-disabled" value="${userAddres.city}"/></div>
                                        <div><label id="tel-msg"></label></div>
                                    </td>
                                </tr><tr>
                                    <th><span class="required">*</span><label >县/区：</label></th>
                                    <td>
                                        <div class="inline-block vam relative">
                                            <input maxlength="50" type="text" name="district" id="district"
                                                   class="text span-310 ime-disabled" value="${userAddres.district}"/></div>
                                        <div><label id="tel-msg"></label></div>
                                    </td>
                                </tr>

                                <tr>
                                    <th rowspan="2" class="selecte-vat"><span class="required">*</span>
                                        <label >详细地址：</label></th>
                                </tr>
                                <tr class="tr-rel">
                                    <td>
                                        <div class="inline-block relative">
                                            <textarea name="address" id="address" class="textarea span-574">${userAddres.address}</textarea>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input maxlength="6" type="text" class="text span-130 ime-disabled" name="code" id="code" value="${userAddres.code}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="inputbox">
                                            <input type="checkbox" class="checkbox" name="defaultFlag" value="1"
                                                   <c:if test="${userAddres.isDefault == 1}">
                                                       checked
                                                   </c:if>
                                                   id="myAddress-default"/>
                                            <span>设为默认收货地址</span></label>
                                    </td>
                                </tr>
                                <tr class="tr-action">
                                    <th>&nbsp;</th>
                                    <td>
                                        <div id="form-edit-button">
                                            ...
                                            <a href="javascript:;" id="button-cancel" class="button-action-cancel"
            ...
            <div class="myAddress-record hide" id="myAddress-record" style="display: block;">
                ...
                <div class="list-group" id="list-group">
                    <div class="list-group-item" id="myAddress-area-63763858">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tbody>

                            <c:forEach items="${userAddress}" var="addr">
                                <tr>
                                    <td class="col-name">${addr.consignee}</td>
                                    <td class="col-address">${addr.province}&nbsp;&nbsp;${addr.city}&nbsp;&nbsp;${addr.district}&nbsp;&nbsp;${addr.address}</td>
                                    <td class="col-zip">${addr.code}</td>
                                    <td class="col-tel"><p>${addr.phone}</p></td>
                                    <td class="col-operate">
                                        <p class="p-edit">
                                            <a class="edit" addressId="${addr.addressId}" href="javascript:;"><span>编辑</span></a>
                                        </p>
                                        <p class="p-del">
                                            <a class="del" addressId="${addr.addressId}" title="删除"><span>删除</span></a></p>
                            ...
                            <script>
                                $(document).ready(function(){
                                    $(".edit").click(function(){
                                        ...
                                        window.location.href="/toaddress?addressId="+addressId;
                                    });
                                    $(".del").click(function(){
                                        var addressId=$(this).attr("addressId");
                                        window.location.href="/toaddres?addressId="+addressId;
                                    });
                                });
	...
	<!-- 20141219-我的地址-编辑成功-start -->
    <div class="box-right-1"><span></span></div>
</textarea>
            <input type="hidden" id="gouldAddress" name="unionPaySwitch" value=1/>
            <script src="../js/userManager-js/address_common.min.js?20170626"></script>
            <script src="../js/userManager-js/address.min.js?20141025"></script>
            <script src="../js/userManager-js/csrftoken.js"></script>
        </div>
        <div class="fl u-1-5">
...
<div class="ol_box_mask" style="visibility: visible; width: 1518px; height: 1637px; z-index: 5000;display: none"></div>

<div id="ol_box" class="ol_box_4"
     style="visibility: visible; position: fixed; top: 203px; left: 529.5px; z-index: 5000; display: none">
    <div class="box-ct">
        <div class="box-header">
            ...
            <div class="box-tc">
                ...
                <div class="box-tc2">
                    <a href="javascript:;" onclick="return false;" title="关闭" class="box-close"></a>
                </div>
            </div>
            ...
            <tr>
                ...
                <td class="box-cc">
                    <div class="box-content" style="height: auto;">
                        <!-- 20141219-我的地址-编辑成功-start -->
                        <div class="box-right-1"><span>恭喜您，已成功添加新地址！</span></div>
                    </div>
                    <div class="box-button">
                        <a class="box-cancel" href="javascript:;" style="display: none;">
                            <span>取消</span></a> <a class="box-ok" href="javascript:;">
                        <span>确定</span></a>
                    </div>
                </td>
                <td class="box-cr"></td>
...
<script>
    function pushMyOrderMsg() {
        ec.account.afterLogin(function () {
            window.location.href = "https://www.vmall.com/member/order?t=1546428024654timestamp";
        });
        var value = {
            "UID": ec.util.cookie.get("uid"),
            "TID": getPtid(),
